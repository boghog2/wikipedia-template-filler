...
class RendererTests(unittest.TestCase):
    def test_inline_output_without_param_spacing(self):
        ...
        self.assertEqual(render_template("cite journal", fields), "{{cite journal |title=Example |doi=}}")
    ...
    def test_inline_output_with_param_spacing_matches_cite_book_fixture(self):
        ...
        self.assertEqual(render_template("cite book", fields, add_param_space=True), fixture["output"])
    ...
    def test_vertical_output_with_param_spacing_matches_protein_fixture(self):
        ...
        self.assertEqual(render_template("infobox protein", fields, add_param_space=True, vertical=True), fixture["output"])
    ...
    def test_fields_from_mapping_preserves_insertion_order(self):
        ...
        self.assertEqual(render_template("demo", fields), "{{demo |first=1 |second=}}")
